...
export class ErlaeuterungenComponent {
  ...
  readonly gbExample =
    "<k><w>hier wird die unkorrigierte Version angezeigt.</w><gb><w>in grüner Farbe</w></gb></k>";
  readonly ngbExample =
    '<w><handshift new="#notgb" customTag="ngb"/><add hand="not gossembrot" customTag="ngb"><w>in grauer Farbe</w></add></w>';
  ...
  readonly teiSymbolExample = '<symbol type="Kreis" desc="Kreis"></symbol>';
