...
import { VerweisViewBlattInfoComponent } from "./view/shared/verweis-view-blatt-info/verweis-view-blatt-info.component";
import { VerweisViewComponent } from "./view/pages/page-verweis-view/verweis-view.component";
import { VerweisLinkIconComponentComponent } from "./view/shared/verweis-link-icon-component/verweis-link-icon-component.component";
import { TargetBlattIsLostFilterComponent } from "./view/pages/page-data-search/page-verweis-search/advanced-verweis-filter/target-blatt-is-lost-filter";
...
import { SearchResultGroupComponent } from "./view/shared/search-result-group/search-result-group.component";
import { SearchResultAuthorComponent } from "./view/shared/search-result-group/search-result-group-components/search-result-authors/search-result-author.component";
import { SearchResultBelegstelleComponent } from "./view/shared/search-result-group/search-result-belegstelle/search-result-belegstelle.component";
...
import { SearchResultCarriertextComponent } from "./view/shared/search-result-group/search-result-group-components/search-result-carriertext.component";
import { ShowMoreToggleComponent } from "./view/shared/search-result-group/search-result-group-components/show-more-toggle";
import { DataSearchSearchComponent } from "./view/pages/page-data-search/page-data-search-search/data-search-search.component";
import { SearchResultsNamingGsmbComponent } from "./view/shared/search-result-group/search-result-group-components/search-results-naming-gsmb.component";
...
@NgModule({
  ...
  exports: [OsdEditorComponent, HighlightBoldPipe, ManuscriptNavComponent],
})
